...
parser.add_argument("--results_csv", type=str, default="results/spucoanimals_class_balance.csv")
...
class_balance = ClassBalanceBatchERM(
    model=model,
...
evaluator = Evaluator(
    ...
    group_weights=trainset.group_weights,
    batch_size=args.batch_size,
    model=class_balance.best_model,
    device=device,
    verbose=True
)
evaluator.evaluate()
