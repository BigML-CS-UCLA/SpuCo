...
parser.add_argument("--results_csv", type=str, default="/data/spucoanimals/results/eiil.csv")
parser.add_argument("--stdout_file", type=str, default="eiil.out")
...
parser.add_argument("--wandb_run_name", type=str, default="spucoanimals_eiil")
