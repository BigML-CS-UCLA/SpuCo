...
from spuco.datasets import SpuCoAnimals, GroupLabeledDatasetWrapper, SpuriousTargetDatasetWrapper
...
parser.add_argument("--results_csv", type=str, default="/data/spuco_animals/results/ssa.csv")
parser.add_argument("--stdout_file", type=str, default="spuco_animals_ssa.out")
...
parser.add_argument("--wandb_run_name", type=str, default="spuco_animals_ssa")
