...
```
guild run spuco_sun_eiil.py root_dir='[/data/spucosun/10.21]'  erm_lr=0.001 erm_weight_decay=0.001 gdro_lr=0.0001 gdro_weight_decay=0.001 infer_num_epochs='[1,2]' eiil_num_steps=20000 arch=cliprn50 only_train_projection=True pretrained=True seed='[2,3]' --stage-trials

guild run spuco_sun_eiil.py root_dir='[/data/spucosun/10.21]'  erm_lr=0.01 erm_weight_decay=0.0001 gdro_lr=0.0001 gdro_weight_decay=0.0001 infer_num_epochs=1 eiil_num_steps=20000 arch=cliprn50 only_train_projection=True pretrained=True seed='[2,3]' --stage-trials
```
...
```
guild run spuco_sun_eiil.py root_dir='[/data/spucosun/10.0]'  erm_lr=0.001 erm_weight_decay=0.001 gdro_lr=0.0001 gdro_weight_decay='[1e-4, 0.001]' infer_num_epochs=2 eiil_num_steps=10000 arch=cliprn50 only_train_projection=True pretrained=True seed='[2,3]' --stage-trials

guild run spuco_sun_eiil.py root_dir='[/data/spucosun/10.0]'  erm_lr=0.001 erm_weight_decay=0.0001 gdro_lr=0.001 gdro_weight_decay=1e-4 infer_num_epochs=1 eiil_num_steps=10000 arch=cliprn50 only_train_projection=True pretrained=True seed='[2,3]' --stage-trials
```