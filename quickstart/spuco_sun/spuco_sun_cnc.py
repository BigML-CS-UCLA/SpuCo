...
parser.add_argument("--results_csv", type=str, default="/data/spucosun/results/cnc.csv")
parser.add_argument("--stdout_file", type=str, default="spuco_sun_cnc.out")
...
parser.add_argument("--wandb_run_name", type=str, default="spuco_sun_cnc")

parser.add_argument("--inf_batch_size", type=int, default=128)
parser.add_argument("--inf_num_epochs", type=int, default=40)
...
cnc_inf = CorrectNContrastInference(
        ...
        optimizer=SGD(model.parameters(), lr=args.inf_lr, weight_decay=args.inf_weight_decay, momentum=args.inf_momentum),
        num_epochs=args.inf_num_epochs,
        device=device,
        verbose=True
    )

print('inferring groups ...')
group_partition = cnc_inf.infer_groups()
...
results["val_attribute_prediction"] = evaluator.evaluate_spurious_attribute_prediction()
...
results["test_attribute_prediction"] = evaluator.evaluate_spurious_attribute_prediction()
