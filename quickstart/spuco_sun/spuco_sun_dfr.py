...
parser.add_argument("--results_csv", type=str, default="/data/spucosun/results/dfr.csv")
parser.add_argument("--stdout_file", type=str, default="spuco_sun_dfr.out")
...
parser.add_argument("--wandb_run_name", type=str, default="spuco_sun_dfr")
