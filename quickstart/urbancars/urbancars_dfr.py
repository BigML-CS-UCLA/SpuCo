...
if __name__ == '__main__':
    ...
    parser.add_argument("--results_csv", type=str, default="results/urbancars_dfr.csv")
    parser.add_argument("--stdout_file", type=str, default="urbancars_dfr.out")
    ...
    parser.add_argument("--wandb_run_name", type=str, default="urbancars_dfr")
