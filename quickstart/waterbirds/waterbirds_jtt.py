...
parser.add_argument("--results_csv", type=str, default="/data/waterbirds/results/jtt.csv")
parser.add_argument("--stdout_file", type=str, default="waterbirds_jtt.out")
...
parser.add_argument("--wandb_run_name", type=str, default="waterbirds_jtt")
