...
parser.add_argument("--results_csv", type=str, default="/data/waterbirds/results/spare.csv")
...
parser.add_argument("--wandb_run_name", type=str, default="waterbirds_spare")
